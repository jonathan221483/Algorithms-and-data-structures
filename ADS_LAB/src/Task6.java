...
public class Task6  {
    public static void main() {
        ...
        int power = scan.nextInt(); //input the number
        System.out.printf(String.valueOf(powerOf(n,power))); //print the return of the function
    }


    public static int powerOf(int number,int power) { //function that finds factorial of the number
        if(power==0) //stop the function if number reaches 0
            return 1;
        else //recursive case
        {
